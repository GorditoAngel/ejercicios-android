...
public class EditorMusicaActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.cd_vinilo:
        	cd_vinilo();
        	return true;
        // Las tres opciones del submenú de "Buscar" mostrarán el ListView (ResultadosMusicaActivity)
    ...
    private void escuchar() {
    	// Se solicita al sistema iniciar la actividad ResultadosMusicaActivity
    	Intent intent = new Intent(EditorMusicaActivity.this, ResultadosMusicaActivity.class);
